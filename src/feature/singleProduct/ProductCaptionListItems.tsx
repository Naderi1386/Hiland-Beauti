...
const ProductCaptionListItems = ({content,title}:ProductCaptionListItemsPropsType) => {
  return (
    <li className="py-3 border-b border-solid border-stone-300 text-stone-600 text-sm sm:text-base ">
      <div className="w-full sm:w-[47.5%] flex items-center justify-between">
